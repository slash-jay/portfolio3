...
export const Footer = () => {
  return (
    <footer className="footer">
      <Container>
        {/* <h1 className="footer-title">CODING PROFILES</h1>
        
        <InteractiveCard className={`journey-item card-texture-${2} interactive-card-slide`}>
          <a href="https://leetcode.com/jai_777/">
            <p className="footer-link">LEETCODE</p>
          </a>
          <a href="https://codeforces.com/profile/jayashankar">
            <p className="footer-link">CODEFORCES</p>
          </a>
          <a href="https://www.codechef.com/users/jaya_777">
            <p className="footer-link">CODECHEF</p>
          </a>
        </InteractiveCard> */}
        ...
        <div className="social-icon">
          <a href="https://www.linkedin.com/in/jayashankar-kona-9038b0249/">
            <img src={navIcon1} alt="LinkedIn" />
          </a>
          <a href="https://github.com/slash-jay">
            <img src={navIcon4} alt="GitHub" />
          </a>
          <a href="mailto:konajayashankar@gmail.com">
            <img src={navIcon5} alt="Email" />
          </a>
          <h2 className="footer-reach">Reach me here</h2>
        </div>
      </Container>
    </footer>
  );
